...
#    Updated: 2025/09/05 18:25:54 by shimi-be         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = exec/exec_utils.c exec/exec_utils2.c exec/exec_utils3.c exec/exec_utils4.c			\
	  ...
	  heredoc/heredoc_utils.c heredoc/heredoc_utils2.c heredoc/heredoc_utils3.c heredoc/heredoc_utils4.c		\
	  quotes/lexer.c quotes/nested_utils.c quotes/nested_utils2.c quotes/nested_utils3.c quotes/quote_utils2.c 	\
	  ...
	  main.c utils/signal_utils.c utils/error_utils.c exec/exec_utils14.c utils/redirect_utils2.c cmd_struct/cmd_struct_utils.c
